...
import ktpdua.crudktp.exceptions.NonexistentEntityException;
import ktpdua.crudktp.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ktpdua_crudktp_jar_0.0.1-SNAPSHOTPU");
